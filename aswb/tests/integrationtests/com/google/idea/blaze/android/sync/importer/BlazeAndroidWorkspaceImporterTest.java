  ...
  public void testEmptyResourceModuleIsAddedAsJar() {
    ...
    TargetMap targetMap =
        targetMap(
            android_library("//java/apps/example/lib0:lib0")
                .src("SharedActivity.java")
                .resource_jar("lib0_resources.jar")
                .manifest("AndroidManifest.xml")
                .dep("//java/apps/example/lib1:lib1", "//java/apps/example/lib2:lib2")
                .generated_jar("lib0.jar")
                .generated_jar("lib0_resources.jar"),
            android_library("//java/apps/example/lib1:lib1")
                .src("SharedActivity")
                .manifest("AndroidManifest.xml")
                .res("res")
                .resource_jar("lib1_resources.jar")
                .generated_jar("lib1.jar")
                .generated_jar("lib1_resources.jar"),
            android_library("//java/apps/example/lib2:lib2")
                .src("SharedActivity.java")
                .manifest("AndroidManifest.xml")
                .res("res")
                .resource_jar("lib2_resources.jar")
                .generated_jar("lib2_resources.jar")
                .generated_jar("lib2.jar"),
            android_binary("//java/apps/example:example_debug")
                .src("MainActivity.java")
                .manifest("AndroidManifest.xml")
                .res("res")
                .dep("//java/apps/example/lib0:lib0")
                .generated_jar("example_debug.jar"));
    ...
    TargetMap targetMap =
        targetMap(
            android_library("//java/example:lib")
                ...
                .res("res")
                .dep("//common_deps:lib"),
            android_library("//common_deps:lib").manifest("AndroidManifest.xml").res("res"));
    ...
    TargetMap targetMap =
        targetMap(
            ...
            android_library("//java/example2:lib")
                ...
                .res("res")
                .generated_res("res"),
            android_library("//java/uninterestingdir:lib")
                .manifest("AndroidManifest.xml")
                .res("res")
                .generated_res("res"));
    importWorkspace(workspaceRoot, targetMap, projectView);
    ...
    TargetMap targetMap =
        targetMap(
            ...
            android_library("//third_party/lib:res_lib")
                .manifest("AndroidManifest.xml")
                .res_folder(
                    AndroidResFolder.builder().setRoot(source("java/example/test_res/res")).build())
